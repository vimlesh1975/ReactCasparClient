...
export function generateDivingHTML(templateId = '', templateName = '', customData = {}, sport = {}, styleOptions = {}) {
  ...
  if (normId.includes('dv002') || normId.includes('dv003') || normId.includes('dv004') || normId.includes('dv005') || normId.includes('dv006') || normId.includes('dv007') || normId.includes('dv008')) {
