...
export const iniBreakingNews = [
    { id: uuidv4(), data1: 'मुख्यमंत्री योगी आदित्यनाथ ने दी मुलायम सिंह को जन्मदिन की बधाई, जानिए क्या कहा', use1: true },
    { id: uuidv4(), data1: 'दिल्ली में प्रदूषण के चलते कंस्ट्रक्शन एक्टिविटी पर लगा प्रतिबंध हटाया गया - NDTV India', use1: true },
    { id: uuidv4(), data1: 'चलने नहीं देंगे रामायण एक्सप्रेस, संतों की वेशभूषा में वेटरों पर साधुओं की चेतावनी', use1: true },
    { id: uuidv4(), data1: 'मंत्रिमंडल विस्तार से क्या ख़त्म हो जाएगी अशोक गहलोत और सचिन पायलट गुट की कलह?', use1: false },
    { id: uuidv4(), data1: 'Shaurya Chakra: शादी के 10 महीने में हुए शहीद, I LOVE YOU कहकर पत्नी ने दी थी अंतिम विदाई', use1: true },
    { id: uuidv4(), data1: 'पाक को खदेड़ने वाले वीर का हुआ अभिनंदन, मेजर विभूति और सूबेदार सोमबीर को शौर्य चक्र', use1: true },
    { id: uuidv4(), data1: 'Lucknow Kisan Mahapanchayat: कृषि कानूनों की वापसी 70 साल में किसान आंदोलनों की सबसे बड़ी जीत', use1: true },
    { id: uuidv4(), data1: 'Pollution: दिल्ली में ट्रकों की एंट्री पर बैन जारी, वर्क फ्रॉम होम 26 नवंबर तक बढ़ा - Aaj Tak', use1: true },
    { id: uuidv4(), data1: 'पठानकोट में आर्मी कैंप के गेट के पास ग्रेनेड धमाका, सभी चौकियां हाई अलर्ट पर - NDTV India', use1: true },
    { id: uuidv4(), data1: 'तानाशाहों के लिए ना गाएं, मारे गए पत्रकार खशोगी की मंगेतर की सिंगर से अपील - आज तक', use1: true },
    { id: uuidv4(), data1: 'El Salvador President Nayib Bukele Said We Will Build World First Bitcoin City Power', use1: false },
    { id: uuidv4(), data1: 'अमेरिका में डॉलर की बारिश: चलते ट्रक से सड़क पर नोटों से भरे कई बैग उड़े, हाईवे पर कारें खड़ी कर लूटने लगे लोग', use1: true },
    { id: uuidv4(), data1: 'ताइवान के आसमान पर चीन ने उड़ाए परणामु बम गिराने वाले विमान, बढ़ा तनाव - Hindustan हिंदी', use1: true },
    { id: uuidv4(), data1: 'Airtel Prepaid Recharge : एयरटेल ने महंगा कर दिया प्रीपेड रिचार्ज, जानें अब कितने का हुआ कौन सा प्लान', use1: true },
    { id: uuidv4(), data1: 'Paytm के शेयरों में तबाही जारी, आज फिर 15% टूटे शेयर, दो दिनों में विजय शर्मा की वेल्थ 78.10 करोड़', use1: true },
    ...
    { id: uuidv4(), data1: 'मुझे मुंबई आने में डर लगता है, परमबीर सिंह की दलील पर SC ने दिया ये आदेश - आज तक', use1: true },
