...
const CasparcgTools = () => {
    ...
    const sendAMCPCommand=()=>{
     var aa= (textAreaContent).split('\r\n');
     alert(aa.length);
        // endpoint(`${textAreaContent}`)
    }
...
<div>
<p>AMCP Commands:</p>
<textarea  rows="4" cols="50" onChange={e=>setTextAreaContent(e.target.value)}>
play 1-1 amb loop
  </textarea>
  <button onClick={sendAMCPCommand}>Send Command</button>
  </div>
            <select onChange={e => changeChannelMode(e)} value={currenttool}>
