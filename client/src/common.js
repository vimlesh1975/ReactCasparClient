...
export const buildDate = "301224_1";
...
export const exportEachPagetoHTML = async (canvas, setIsLoading, canvasList) => {
  ...
  try {
    ...
    for (const [index, val] of canvasList.entries()) {
      ...
      const fileName = `${(val.pageName).replace(/[\\/:*?"<>|]/g, "_")}.html`;
