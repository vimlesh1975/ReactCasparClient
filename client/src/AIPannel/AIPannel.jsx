...
/** Helper to apply broadcast‑grade defaults to any Fabric object */
const applyDefaults = (obj) => {
  // Ensure deterministic defaults for broadcast reliability
  obj.set({
    objectCaching: false,
    shadow: { color: '#000000', blur: 30, offsetX: 0, offsetY: 0, affectStroke: false },
  });
  return obj;
};

/** Add an image URL to the shared Fabric canvas */
const addImageToCanvas = (canvas, imgUrl) => {
